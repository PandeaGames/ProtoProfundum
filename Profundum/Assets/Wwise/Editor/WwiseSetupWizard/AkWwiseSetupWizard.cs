...
For more information on a particular setting, hover your mouse over it.", 
	...
	public static void ShowHelp()
	{
		try
		{
			...
			string DestPath = AkUtilities.GetFullPath(Application.dataPath, "../WwiseUnityIntegrationHelp_AppleCommon_en");
			UnzipHelp (DestPath);
			string docPath = string.Format ("{0}/html/index.html", DestPath);
